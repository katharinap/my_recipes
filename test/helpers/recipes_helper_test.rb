...
class RecipesHelperTest < ActionView::TestCase
  ...
  context '.destroy_link' do
    should 'return proper markup when allow_edit? == false' do
      stubs(:allow_edit?).returns(false)
      expected_markup =
          "<a data-toggle=\"tooltip\" title=\"Nope...\" disabled=\"disabled\" class=\"disabled\" href=\"#\"><span class=\"right-side-icon\"><i class=\"fa fa-trash fa-lg\" aria-hidden=\"true\"></i></span></a>"
    ...
    should 'return proper markup when allow_edit? == true' do
      ...
      instance_variable_set(:@virtual_path, "en")
      expected_markup =
          "<a data-confirm=\"Are you sure?\" data-toggle=\"tooltip\" title=\"Delete\" rel=\"nofollow\" data-method=\"delete\" href=\"/recipes/598873390\"><span class=\"right-side-icon\"><i class=\"fa fa-trash fa-lg\" aria-hidden=\"true\"></i></span></a>"
      assert_equal expected_markup, destroy_link(@recipe)
    end
  end
